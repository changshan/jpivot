 ...
 * </copyright>
 *
 * $Id: RoleTypeItemProvider.java,v 1.2 2004/06/30 13:45:51 avix Exp $
 */
...
/**
 * This is the item provider adpater for a {@link net.sourceforge.mondrian.schema.Mondrian.RoleType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RoleTypeItemProvider
    ...
    itemPropertyDescriptors.add
      (new ItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_RoleType_name_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_RoleType_name_feature", "_UI_RoleType_type"),
         MondrianPackage.eINSTANCE.getRoleType_Name(),
         true,
  ...
  public Collection getChildrenFeatures(Object object) {
    if (childrenFeatures == null) {
      ...
      childrenFeatures.add(MondrianPackage.eINSTANCE.getRoleType_SchemaGrant());
    }
  ...
  public String getText(Object object) {
    Object labelValue = ((RoleType)object).getName();
  ...
  protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
    ...
    newChildDescriptors.add
      (createChildParameter
        (MondrianPackage.eINSTANCE.getRoleType_SchemaGrant(),
