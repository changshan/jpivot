 ...
 * </copyright>
 *
 * $Id: DimensionTypeItemProvider.java,v 1.2 2004/06/30 13:45:51 avix Exp $
 */
...
/**
 * This is the item provider adpater for a {@link net.sourceforge.mondrian.schema.Mondrian.DimensionType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DimensionTypeItemProvider
    ...
    itemPropertyDescriptors.add
      (new ItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_DimensionType_foreignKey_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_DimensionType_foreignKey_feature", "_UI_DimensionType_type"),
         MondrianPackage.eINSTANCE.getDimensionType_ForeignKey(),
         true,
  ...
  protected void addNamePropertyDescriptor(Object object) {
    itemPropertyDescriptors.add
      (new ItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_DimensionType_name_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_DimensionType_name_feature", "_UI_DimensionType_type"),
         MondrianPackage.eINSTANCE.getDimensionType_Name(),
         true,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE));
  }
  ...
  public Collection getChildrenFeatures(Object object) {
    if (childrenFeatures == null) {
      ...
      childrenFeatures.add(MondrianPackage.eINSTANCE.getDimensionType_Hierarchy());
    }
  ...
  public Object getImage(Object object) {
    return getResourceLocator().getImage("full/obj16/DimensionType");
  }
  ...
  public String getText(Object object) {
    Object labelValue = ((DimensionType)object).getName();
  ...
  protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
    ...
    newChildDescriptors.add
      (createChildParameter
        (MondrianPackage.eINSTANCE.getDimensionType_Hierarchy(),
